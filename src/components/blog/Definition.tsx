...
export function Definition({ term, children, source }: DefinitionProps) {
  return (
    <div class="p-3 -ml-3 bg-gradient-to-tl from-gray-100 via-transparent to-transparent rounded overflow-hidden not-prose flex flex-col gap-y-2">
      <div class="flex items-center justify-between text-sm">
        ...
        {source && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            class="text-secondary-800 flex items-center gap-x-1"
          >
            <span>source</span>
