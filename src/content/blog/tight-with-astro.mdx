...
import { Counter } from "@components/posts/new-site/Counter";
...
let $x$ be some variable, then:

$$
f(x) = \frac{x^2}{2\cdot a\cdot b}
$$
...
![Home page with devtools network tab open, no JS files shown](@assets/posts/new-site/no-js.png)
...
![Open Graph image for this post](@assets/posts/new-site/dynamic-og.png)
