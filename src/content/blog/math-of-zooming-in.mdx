...
For zooming and panning, we'll use translation and scaling transformations, respectively. To translate a space horizontally by $t_x$ and vertically by $t_y$, or scale by $s$, you can apply the following matrices:
...
So how do we use "window mapping" to implement a "zooming in" feature? Let's say you have somme sort of 300px x 300px canvas drawing, and you'd like to implement a "zooming in" feature on it. I like to break this down into three main pieces:
...
TODO: Diagram mapping out the above.
...
TODO: Do we add a JXG illustration where they can shrink/grow the input window?
